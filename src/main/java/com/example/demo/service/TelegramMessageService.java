...
import static com.example.demo.util.utilClasses.HTMLFileToString;
...
public class TelegramMessageService
{
    ...
    {
        String messageToSend = HTMLFileToString("src/main/resources/static/clusterBuyTelegramMessage.html");
